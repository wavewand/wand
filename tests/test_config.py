...
IntegrationsConfig = config_module.IntegrationsConfig
...
class TestConfig:
    ...
    def test_load_from_json(self):
        ...
        test_config = {
            "server": {"http_port": "9000", "metrics_port": "9090"},
            "integrations": {"slack": {"bot_token": "test-token", "default_channel": "#test"}},
        }
    ...
    def test_security_config(self):
        ...
        # JWT secret is now auto-generated if not set
        assert len(config.security.jwt_secret) > 0  # Should have a generated secret
        assert config.security.jwt_secret != "your-secret-key"  # Not the hardcoded value
